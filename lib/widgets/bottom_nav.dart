...
class _BottomNavState extends State<BottomNav> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.fromLTRB(widget.horizontalMargin, 0, widget.horizontalMargin, 12),
      padding: const EdgeInsets.all(6),
      decoration: BoxDecoration(
        color: const Color.fromRGBO(22, 21, 31, .82),
                  ...
                  Positioned(
                    ...
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: WBColors.amberA(.28)),
...
class _NavItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = Color.lerp(WBColors.textA(.5), WBColors.amber, selection)!;
    return Pressable(
      onTap: onTap,
      borderRadius: BorderRadius.circular(18),
      child: SizedBox(
